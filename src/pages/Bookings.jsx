...
//           className="mt-6 w-full text-center text-sm font-semibold text-red-600 border border-red-400 rounded-full py-2 hover:bg-red-600 hover:text-white transition"
//         >
//           Cancel Appointment
//         </button>
//       </div>
